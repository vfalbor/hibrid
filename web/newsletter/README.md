# newsletter (launch artifacts)

Snapshot of the hibrid newsletter posts, published live at
...
- `2026-06-26-hibrid-router-that-knows-your-machine.html` — the launch post, updated with the
  study's charts and the no-API-key note.
- `index.html` — a snapshot of the live newsletter index (also lists the site's weekly posts,
  which live in the LLM Daily Review project, not here).
- `img/` — the benchmark charts (`tps`, `quality_axis`, `local_parity`).
